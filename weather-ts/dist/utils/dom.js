...
export function getWeatherEmoji(weatherCondition) {
...
export function updateBackground(weatherCondition, temp) {
...
export function displayWeatherData(data, elements) {
...
export function displayForecast(data, forecastCards) {
...
export function displayHistory(history, historySection, historyButtons, onCityClick) {
    if (history.length === 0) {
